    ...
    <header class="header">
        <div class="header_layout">
            <div class="coachtech_flea_market">
                <!-- <img class="coachtech_logo" src="images/logo.svg" alt="coachtech"> -->

                <a href="/">
                    <div class="coachtech_logo">
                        <svg class="coachtech_logo_svg" width="300" height="62" viewBox="-10 0 310 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="search_box">
                <input class="search" type="search" name="search_space" placeholder="なにをお探しですか？">
            </div>
            <div class="nav">
